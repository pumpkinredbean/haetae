...
Haetae is a research alpha. No released version is currently supported for
production security updates. Security fixes are applied to the default branch
...
the HTTP service, or dependency loading. Maintainers will acknowledge the
report, reproduce it against a pinned commit, and coordinate disclosure after
a fix is available.
