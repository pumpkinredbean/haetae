"""Versioned shared-v1 architecture for the portable generation 79 runtime.
...
The architecture and packing core were copied from experiments/shared_state.py
at the source identity recorded below. Model construction is local-only here.
"""
...
SOURCE_IMPLEMENTATION_PATH = "experiments/shared_state.py"
SOURCE_IMPLEMENTATION_SHA256 = (
    "741f68296f756fd2301f5adf909a84eb84e43d94369536a29bf2d67be788e356"
)
SOURCE_BASE_COMMIT = "4828f9c69ba0f5b1f64fd72aa35fa3ce7269d294"
...
def build_shared_state_model(config, tokenizer, device: str,
                             pointer_size: int = 128,
